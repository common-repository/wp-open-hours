...
(function ($) {
    $.fn.county = function (options) {
        ...
        return this.each(function () {
            ...
            container.append('<span class="county-days-wrapper first"></span><span class="county-hours-wrapper separator-left border-separator-right"><span class="county-hours">00</span> hrs&nbsp;</span><span class="county-minutes-wrapper separator-left separator-left"><span class="county-minutes"> 00</span></span> mins <div class="clear"></div>');
